...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aws-sso-util-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13646&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aws-sso-util-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aws-sso-util` can be installed with:

```
conda install aws-sso-util
```

It is possible to list all of the versions of `aws-sso-util` available on your platform with:
